    ...
    if request.method == 'POST':
        try:
            ...
            servicio_id = request.POST.get(
                'servicio_id') or request.POST.get('evento_id')
            ...
            precio_por_unidad = request.POST.get(
                'precio_por_unidad', '0').replace(',', '.')
